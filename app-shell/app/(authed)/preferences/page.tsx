...
const TOGGLE_GROUPS: ToggleGroup[] = [
  ...
  },
  {
    ...
    toggles: [
      ...
      { key: 'importSlaAtRiskAlertEmails', label: 'SLA-at-risk daily alert', desc: 'Daily 08:15 watch list of unquoted requests past 75% of your negotiated turnaround target, split into at-risk and already-breached. The breach-prevention signal — every listed row still has a customer waiting. Healthy days send no email.' },
      ...
      { key: 'importQuoteFollowUpAlertEmails', label: 'Aging-quotes daily alert', desc: 'Daily morning watch list of quotes sitting in the customer-decision phase for more than 5 days. Sibling of the stalled-queue alert but on the customer side of the workflow — nudge or re-quote to unstick. Healthy days send no email.' },
      ...
      { key: 'importExpiredQuotesAlertEmails', label: 'Expired-quotes weekly alert', desc: 'Tuesday morning loss report: quotes that hit expiry with no customer decision in the last 30 days, with the € at stake. Each row is a re-quote candidate — the freshest are the most recoverable. Clean months send no email.' },
