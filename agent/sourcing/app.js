const API_ENDPOINT = '/api/sourcing-agent';
...
const TOOL_LABELS = {
  compareSourcingCountries: 'Comparing sourcing countries',
  assessSourcingRisk: 'Assessing country × category risk',
  estimateSourcingLeadTime: 'Estimating lead time',
  listSupplierShortlist: 'Loading supplier shortlist',
...
async function send(text) {
  ...
  try {
    ...
    console.error('Sourcing Agent stream failed', error);
...
const STORAGE_KEY = 'orcatrade.sourcing.messages.v1';
