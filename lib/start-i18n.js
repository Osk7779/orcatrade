...
${tierABlockEn(plan.customs && plan.customs.tier_a)}${tierABlockSourcingEn(plan.sourcing && plan.sourcing.tier_a)}${tierABlockRoutingEn(plan.routing && plan.routing.tier_a)}
...
${tierABlockPl(plan.customs && plan.customs.tier_a)}${tierABlockSourcingPl(plan.sourcing && plan.sourcing.tier_a)}${tierABlockRoutingPl(plan.routing && plan.routing.tier_a)}
...
${plan.warehouse?.recommendation ? `- 3PL-Hub: ${plan.warehouse.recommendation.primary}` : ''}
${tierABlockDe(plan.customs && plan.customs.tier_a)}${tierABlockSourcingDe(plan.sourcing && plan.sourcing.tier_a)}${tierABlockRoutingDe(plan.routing && plan.routing.tier_a)}
