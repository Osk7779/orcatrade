...
${tierABlockEn(plan.customs && plan.customs.tier_a)}
...
${tierABlockPl(plan.customs && plan.customs.tier_a)}
...
${plan.warehouse?.recommendation ? `- 3PL-Hub: ${plan.warehouse.recommendation.primary}` : ''}
${tierABlockDe(plan.customs && plan.customs.tier_a)}
...
module.exports = { STRINGS, pickLocale, tierABlockEn, tierABlockPl, tierABlockDe };
