...
//
// Same shape as customs-quote.buildTierAInput (PR #89). Every finance
// function returns { ok, inputs: { amountEur, ... }, asOf, … } — we
// project amountEur → amountCents (integer cents per ADR 0004) and
// stamp a mirror snapshot from PRICING_SNAPSHOT.
//
// Future: when ECB FX is wired into estimateFxHedgingCost (replacing
// FX_TABLE.annualForwardPremiumPercent with a live rate), the quote
// will carry liveRateMeta and Tier-A will additionally pin a primary_
// regulator snapshot — TA-2 will then pass for FX hedging quotes.
