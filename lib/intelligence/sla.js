...
/**
 * @param {{ createdAt?: string, quotedAt?: string | null, status?: string, targetHours?: number, nowMs?: number }} args
 */
function computeSlaCommitment({ createdAt, quotedAt, status, targetHours, nowMs } = {}) {
