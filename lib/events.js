...
const ALLOWED_TYPES = new Set([
  ...
  'document_approved',
  'document_rejected',
  // Sprint marketplace-v1 (apex II7) — user requested an intro to a
  // trade-finance / insurance provider. Carries { email, providerId,
  // providerName, products, takeRatePct, note } — email hashed in Postgres
  // mirror so the take-rate accounting + audit trail survives without
  // leaking provider negotiations.
  'marketplace_intro_requested',
]);
