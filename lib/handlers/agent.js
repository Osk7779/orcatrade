...
module.exports = async (req, res) => {
  ...
  // See lib/gating.checkAgentSpend for the fail-OPEN posture +
  // PR #45 for the rationale (defensive floor alongside the
  // agentQueriesPerMonth quota).
      ...
      const response = await withCostTelemetry(
        {
          ...
          // P1.7 spend ledger — see PR #45 for the ledger contract.
