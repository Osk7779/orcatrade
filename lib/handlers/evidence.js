...
const { extractEvidenceBundle, mergeComplianceInputWithEvidence, validateEvidenceDocuments } = require('../intelligence/evidence-ingestion');
const { normaliseComplianceInput } = require('../intelligence/compliance');
const {
...
} = require('../intelligence/report-access');
const { applyRequestHeaders, buildRequestContext, buildRequestMeta, emitAuditEvent } = require('../intelligence/request-runtime');
