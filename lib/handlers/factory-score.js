...
Return exactly this JSON:
{
  ...
  try {
    const res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        // MUST mirror MODELS.TRIAGE in lib/ai/models.js. NOT imported from
        // the registry because this file is ESM-syntax under a CJS dispatcher
        // and import shape is unresolved (see PR #7 body, "Discovered issue").
        // Follow-up: convert factory-score.js to CJS + adopt MODELS registry.
