...
test('classifyTool tags compliance tools as "compliance"', () => {
  for (const name of ['checkCbamApplicability', 'estimateCbamExposure', 'checkEudrApplicability', 'assessReachCompliance', 'checkCeApplicability', 'getComplianceCalendar', 'screenCounterparty']) {
